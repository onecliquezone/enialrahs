...
export EDX_CONFIGURATION_PUBLIC_GITHUB_ACCOUNTNAME=$EDX_CONFIGURATION_PUBLIC_GITHUB_ACCOUNTNAME
export EDX_CONFIGURATION_PUBLIC_GITHUB_PROJECTNAME=$EDX_CONFIGURATION_PUBLIC_GITHUB_PROJECTNAME
export EDX_CONFIGURATION_PUBLIC_GITHUB_PROJECTBRANCH=$EDX_CONFIGURATION_PUBLIC_GITHUB_PROJECTBRANCH
export EDXAPP_LMS_BASE=$EDXAPP_LMS_BASE
export EDXAPP_CMS_BASE=$EDXAPP_CMS_BASE
